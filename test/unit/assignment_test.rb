...
class AssignmentTest < ActiveSupport::TestCase
  ...
  context "validate" do
    ...
    should "catch a negative tokens_allowed value" do
      a = Assignment.new(:tokens_allowed => '-10')
      assert !a.valid?, "assignment expected to be invalid when tokens_allowed is < 0"
    end
  end
